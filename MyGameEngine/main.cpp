// MyGameEngine.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MYGAMEENGINE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MYGAMEENGINE);
